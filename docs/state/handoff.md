...
- 002 Sichtprüfung erledigt; auf Wunsch h1–h3 in SSBL-Blau (decisions Nr. 18).
...
- produkte.ts prüft `foto` per fs relativ zu process.cwd() · og:image nur mit adresse + ogBild.
...
- 008 (Bild-Baustein, nötig für Hero + Produktkarten); ebenfalls bereit: 004–006, 009–011, 013, 018.
